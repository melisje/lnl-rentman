...
use App\Models\Rentman\TimeregistrationActivity;
use App\Services\Rentman\Api\AbstractRentmanFetcher;
use Illuminate\Support\Facades\Log;
use Illuminate\Support\Facades\Schema;

class TimeRegistrationActivityFetcher extends AbstractRentmanFetcher
{
    /**
    ...
    public function processPage(string $account, array $items): void
    {
        foreach ($items as $item)
        {
            ...
            $model = TimeregistrationActivity::updateOrCreate(
            ...
            // there are no custom fields for timeregistration activities, so we don't need to process them here.
